...
export default function Homepage() {
        ...
        <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
          <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
            ...
            <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
              <Link to="/order" className="font-medium text-gray-500 hover:text-gray-900">Order Meal</Link>

              <Link to="/managemenu" className="font-medium text-gray-500 hover:text-gray-900">Manage Menu</Link>
            </div>
          </nav>
        </div>
  ...
  <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://images.pexels.com/photos/3026808/pexels-photo-3026808.jpeg" alt=""/>
  </div>
</div>
    )
}
